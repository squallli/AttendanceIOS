...
class DatePickerDialog: UIView {
    ...
    typealias DatePickerCallback = (_ date: Foundation.Date) -> Void
    ...
    /* Vars */
    fileprivate var defaultDate:    Foundation.Date?
    ...
    func show(_ title: String, doneButtonTitle: String = "Done", cancelButtonTitle: String = "Cancel", defaultDate: Foundation.Date = Foundation.Date(), datePickerMode: UIDatePickerMode = .dateAndTime, callback: @escaping DatePickerCallback) {
        ...
        self.datePicker.date = self.defaultDate ?? Foundation.Date()
